...
[C][B][11EAFD]━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]sumon 9x [00FF00]!!
"""
...
def remove_from_whitelist(uid_to_remove):
    ...
    if uid_str == "3570567991":  # Your UID
              ...
              # =================== EMOTE DETECTION ONLY ===================
                    ...
                    try:
                        ...
                        if True:
                            ...
                            try:
                                ...
                                bot_uid = 13420138628
                                message_text = f" Can't accept Your request Talk to SUMON 9X"
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[[B][C][9B59B6]╔═══◆ WELCOME TO SUMON 9X BOT ◆═══╗
[7F8C8D]╟──────────────────────────────╢
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/wlremove'):
                            ...
                            # Check owner
                            if str(response.Data.uid) != "3570567991":
...
"""
                            ...
                            if str(response.Data.uid) != "3570567991":  # Replace with your actual UID
...
"""
                        ...
                        if inPuTMsG.strip() == '/wllist':
                            ...
                            # Check if owner
                            if str(response.Data.uid) != "3570567991":  # Your UID
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "3570567991":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {uid}"
                                    count += 1
                                    if count >= 20:
...
[C][B][FF0000]│[00FF00]♪[FF0000]│[FFFFFF]║[00BFFF]GUILD Rules[FFFFFF]║
[C][B][FFD700]╰[FF0000]─[FFD700]╯[FFFFFF]
[C][B][FF0000]━━━━━━━━━━━
[C][B][FFFFFF]GUILD NAME [00BFFF]ꫝɪ ꮯɪᴛʏ
[C][B][FFFFFF]প্রতি সপ্তাহে ১০০০ 
[C][B][FFFFFF]গ্লরি না করলে
[C][B][FFFFFF]গিল্ড থেকে
[C][B][FFFFFF]বের করে দেওয়া হবে
[C][B][FFFFFF]আর
[C][B][FFFFFF]গিল্ডে সবার সাথে ভালো 
[C][B][FFFFFF]ব্যবহার করতে হবে❤️
[C][B][FFFFFF]আদেশক্রমে sumon_9x_official
[C][B][FF0000]━━━━━━━━━━━
"""
